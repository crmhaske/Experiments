...
if cueType=="exo":
    ...
    elif exp==2 or exp==3 or exp==4 or exp==6 or exp==7:
...
for blocknum in range(0, numBlocks + 1):
    ...
    if blocknum == 0:
        ...
        if blocknum==1:
            ...
            str=['seq1', 'seq2', 'simul']
            if blocknum == 3:
                bOrder=random.sample(str,len(str))
                blockType=bOrder[0]
            if blocknum == 4:
                blockType=bOrder[1]
            if blocknum == 5:
        ...
        #Sequential trials
        if blockType=="seq" or blockType=="seq1" or blockType=="seq2":
            if blocknum==1:
                notdone=True
            ...
            for trialnum in range(1, curnumtrials + 1):
             ...
             #Used to determine between trial time
                ...
                #Cue slides if cueing
                if cueType=="exo" and blockType=="seq1":
                    if validCue != "neutral" and practice==False:
                        #Cue displayed for cueTime
                        if cueType=="endo":
                            fixationTR.draw()
                        ...
                        if cueType=="endo":
                            ...
                            fixation.draw()
                            if exp==2 or exp==3 or exp==4 or exp==6 or exp==7:
                                cue1.draw()
                                cue2.draw()
                                cue3.draw()
                                cue4.draw()
                ...
                while True:
                    ...
                    if curtime>=timeFix2seq:
						...
						#Cue slides if cueing
                if cueType=="exo" and blockType=="seq2":
                    if validCue != "neutral" and practice==False:
                        #Cue displayed for cueTime
                        if cueType=="endo":
                            fixationTR.draw()
